...
Generated: 2026-07-13 15:52:13 WIB
...
```json
{
  "proxmox": {
    ...
    "ping": {
      "rc": 0,
      "out": "PING 10.10.10.2 (10.10.10.2): 56 data bytes\n64 bytes from 10.10.10.2: icmp_seq=0 ttl=64 time=2.292 ms\n\n--- 10.10.10.2 ping statistics ---\n2 packets transmitted, 2 packets received, 0.0% packet loss, 1 packets out of wait time\nround-trip min/avg/max/stddev = 2.292/7.183/12.074/4.891 ms\n",
      "err": ""
    },
    "ssh": {
      "rc": 0,
      "out": "pve\nMon Jul 13 03:52:15 PM WIB 2026\n",
      "err": ""
    }
  },
  "docker-vm": {
  ...
  "omv": {
    ...
    "ping": {
      "rc": 0,
      "out": "PING 10.10.10.82 (10.10.10.82): 56 data bytes\n64 bytes from 10.10.10.82: icmp_seq=0 ttl=64 time=3.278 ms\n\n--- 10.10.10.82 ping statistics ---\n2 packets transmitted, 2 packets received, 0.0% packet loss, 1 packets out of wait time\nround-trip min/avg/max/stddev = 3.278/4.139/5.001/0.862 ms\n",
      "err": ""
    },
    "ssh": {
      "rc": 0,
      "out": "openmediavault8\nMon Jul 13 15:52:34 WIB 2026\n",
      "err": ""
    }
  }
}
